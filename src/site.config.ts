...
export const themeConfig: PortfolioConfig = {
  title: basics.name,
  description: `${basics.name} is a ${basics.jobTitle} in the Bay Area with 10+ years building cloud infrastructure & developer platforms. Currently at Anthropic, previously dbt Labs, Lattice, Box, and SAP.`,
  author: basics.name,
  site: basics.url,
  theme: "default",
  nav: [],
